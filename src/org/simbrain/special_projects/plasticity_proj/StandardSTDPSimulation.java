...
public class StandardSTDPSimulation {
    /*
    ...
    private static String IN_FILE_NAME = "./ZSim_Inputs/Separation_Test"
    ...
    private static final double I_LR = 1E-4;
    private static final double E_LR = 1E-4;
    private static final double II_W_PLUS = 3.5;
    private static final double II_W_MINUS = 2.5;
    private static final double IE_W_PLUS = 4.0;
    private static final double IE_W_MINUS = 1.75;
    private static final double E_W_PLUS = 3.5;
    private static final double E_W_MINUS = 2.5;
    private static final double II_TAU_PLUS = 17;
    private static final double II_TAU_MINUS = 34;
    private static final double IE_TAU_PLUS = 17;
    private static final double IE_TAU_MINUS = 34;
    private static final double E_TAU_PLUS = 17;
    private static final double E_TAU_MINUS = 34;
    ...
    private static double IN_DENSITY = 0.05; // make this closer to 1 for less
    ...
    private static final double BETA_IP = 100;
    ...
    public static void runAnnealingProcedure() {
        ...
        try {
            for (int i = 0, n = TEST_RUNS * TEST_DATA.length; i < n; i++) {
                ...
                if (i % TEST_DATA.length == 0 && i > 17 * TEST_DATA.length) {
                ...
                if (prune && LAIP_RES_SYNS.size() < 50000 ) {
                    prune = false;
                ...
                if (i == 18 * TEST_DATA.length) {
                    ...
                    for (Neuron neu : LAIP_RES.getNeuronList()) {
                        ((IPIFRule) neu.getUpdateRule()).setIpConst(1E6);
                        ...
                        ((IPIFRule) neu.getUpdateRule()).setBackgroundCurrent(13.5);
                    }
                }
