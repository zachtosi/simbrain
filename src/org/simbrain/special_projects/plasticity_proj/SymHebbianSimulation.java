...
public class SymHebbianSimulation {
    /*
    ...
    private static int NUM_INPUTS = 137;
...
//    private static final boolean IE_STDP_HEB = true;
    private static final double I_LR = 5E-6; //5E-2 BCM
    private static final double E_LR = 5E-6; //5E-2 BCM
...
//    }
    ...
    static {
        ...
        E_SYN_PLASTICITY.setSymTau(10);
        E_SYN_PLASTICITY.setWtSoftening(60);
        ...
        IE_SYN_PLASTICITY.setWtSoftening(60);
        ...
        II_SYN_PLASTICITY.setSymTau(10);
        II_SYN_PLASTICITY.setWtSoftening(60);
    ...
    private static final double DIST_PARAM_1 = 3; // "Location" if dist is
                                                  // lognormal
    private static final double DIST_PARAM_2 = 4.5; // "Scale" if dist is
                                                  // lognormal
    ...
    private static double IN_DENSITY = .2; // make this closer to 1 for less
    ...
    private static final double I_BG = 14; // nA
    ...
    private static final double ALPHA_IP = 2;// 5;
...
//        LAIP_RES_SYNS.setSpikeResponder(new UDF(), Polarity.BOTH);
        ...
        INPUT_LAYER.setTestDataSpiking("hip.dat");
        TEST_DATA = new double[180000][];
